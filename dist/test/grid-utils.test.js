...
describe('Grid Utils', () => {
    ...
    it("createGridData: 2 with update", function () {
        var actual = common.GridUtils.createGridData(2, 0);
        actual[0][0] = 1;
        actual[0][1] = 2;
        actual[1][0] = 3;
        actual[1][1] = 4;
    ...
    it('getAddress with offset', function () {
        ...
        chai_1.assert.equal(1, common.GridUtils.getAddressX(new common.Point2D(5, 4), config));
        chai_1.assert.equal(1, common.GridUtils.getAddressY(new common.Point2D(5, 4), config));
        chai_1.assert.equal(0, common.GridUtils.getAddressX(new common.Point2D(-5, -4), config));
        chai_1.assert.equal(0, common.GridUtils.getAddressY(new common.Point2D(-5, -4), config));
    });
    it('addPoint with offset', function () {
        ...
        chai_1.assert.equal(gridNode.data[1][1], 1);
    });
    it("Grid update: addLine", function () {
        ...
        gridNode.addLine(new common.Line2D(new common.Point2D(0, 0), new common.Point2D(0, 0)), false);
        chai_1.assert.equal(gridNode.data[5][5], 0);
    });
    it("Grid update: ", function () {
        ...
        common.GridUtils.updateGridDistance(gridNode, robotNode, distanceNode, distance);
        chai_1.assert.equal(gridNode.data[4][9], gridConfiguration.unknownValue);
        chai_1.assert.equal(gridNode.data[5][9], maxObstacle);
        chai_1.assert.equal(gridNode.data[6][9], gridConfiguration.unknownValue);
        chai_1.assert.equal(gridNode.data[5][8], gridConfiguration.unknownValue);
        chai_1.assert.equal(gridNode.data[6][8], gridConfiguration.emptyValue);
        chai_1.assert.equal(gridNode.data[7][8], gridConfiguration.unknownValue);
        chai_1.assert.equal(gridNode.data[6][7], gridConfiguration.unknownValue);
        chai_1.assert.equal(gridNode.data[7][7], gridConfiguration.unknownValue);
        chai_1.assert.equal(gridNode.data[8][7], gridConfiguration.unknownValue);
    });
    it('Rasterize', function () {
        var config = new common.GridConfiguration(10, 1, 1, new common.Vector3D(0, 0, 0));
        var res = common.GridUtils.rasterize(new common.Line2D(new common.Point2D(3, 3), new common.Point2D(1, 1)), true, config);
        //console.log(res);
        chai_1.assert.equal(res[0][0], 3);
        chai_1.assert.equal(res[0][1], 3);
        chai_1.assert.equal(res[1][0], 2);
        chai_1.assert.equal(res[1][1], 2);
        chai_1.assert.equal(res[2][0], 1);
        chai_1.assert.equal(res[2][1], 1);
    });
});
